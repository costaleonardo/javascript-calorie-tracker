...
var ItemCtrl = (function(){
  // Item Constructor
  var Item = function(id, name, calories){
    this.id = id;
    this.name = name;
...
// App Controller
var App = (function(ItemCtrl, StorageCtrl, UICtrl){
  ...
  var itemEditClick = function(e){
    if(e.target.classList.contains('edit-item')){
      ...
      // Get item
      var itemToEdit = ItemCtrl.getItemById(id);
  ...
  // Update item submit
  var itemUpdateSubmit = function(e){
    // Get item input
    var input = UICtrl.getItemInput();

    // Update item
    var updatedItem = ItemCtrl.updateItem(input.name, input.calories);
  ...
  // Delete button event
  var itemDeleteSubmit = function(e){
    // Get current item
    var currentItem = ItemCtrl.getCurrentItem();
  ...
  // Clear items event
  var clearAllItemsClick = function(){
